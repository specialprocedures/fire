...
hex_color_regex = re.compile("(#(?:[0-9a-fA-F]{8})|#(?:[0-9a-fA-F]{3}){1,2})\\b")
...
regexes = {
    ...
    "ipv6s": ipv6_regex,
    "prices": price_regex,
    "hex_colors": hex_color_regex,
    "credit_cards": credit_card_regex,
    "btc_addresses": btc_address_regex,
    "street_addresses": street_address_regex,
}
